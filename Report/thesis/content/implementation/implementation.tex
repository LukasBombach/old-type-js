...
With the second optional parameter, settings can be passed to determine the editor's behavior. As for the implementation of this thesis two settings are avaialable: To determine the behavior on paste eventsand to turn off default keyboard shortcuts. A full description can be found in figure ABC. Section \refsection{sec:extensions} discusses how extensions of the library can add further options for their own use.
