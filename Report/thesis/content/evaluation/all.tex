...
\item Lists can already be inserted and edited, but they cannot be removed.
...
\item Block and inline formattings behave differently when being applied. To decide which type of formatting to apply, the tag name of the formatting command can be checked and a distinct algorithm for block formattings must be implemented.
\item Basic real-time collaboration works
\end{enumerate}
