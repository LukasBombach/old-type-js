...
Most importantly, formatting commands do not distinguish between inline and block formattings and tags to format the content with do not allow passing attributes. This means that text cannot be aligned, colored and sized and that links cannot be added yet.
