...
Most importantly, formatting commands do not distinguish between inline and block formattings and tags to format the content with do not allow passing attributes. This means that text cannot be styled with CSS, which takes away many formatting options, and that links cannot be added yet.
The best experience can be achieved on Google Chrome.
