...
By the recommendation of the W3C, a document marked up with HTML must be represented by a Document Object Model \cite{DOM1}, a tree structure containing every tagged element and its texts as nodes.
