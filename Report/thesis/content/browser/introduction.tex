...
% \footnote{Whether a specific component or API can be used or not, is determined by the intended audience and browser market share.}

This chapter will discuss the basics of plain-text and rich-text editing in browsers as well as the APIs and techniques that browsers provide.%as well as the specifics of implementing a rich-text editor in the browser without the use of hacks.
