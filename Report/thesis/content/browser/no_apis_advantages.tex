...
With a pure JavaScript implementation, many of the problems that HTML editing APIs have, can be solved. The issues discussed in \refsection{sec:disadvantages_of_html_editing_apis} will be discussed in this context hereinafter.
