...
The library should be capable of any method that HTML editing APIs implement. However the API can differ to improve they way it will be worked with. The API design will be discussed in \refsection{sec:api_design}.
