...
Before the text read from the hidden \code{textarea} will be passed on to the \code{Changes} class, it will be passed though a series of \code{Filter}s, called the ''input pipeline''. 

\begin{itemize}
\item Catch input that that shoud trigger functions of the library
