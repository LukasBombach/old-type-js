...
These rules perfom the minimally necessary steps to format contents while conforming the HTML validation rules. By adding only the minimum of nodes, this will ensure simple markup.
