...
\begin{enumerate}
\item Compute a new changeset by merging $X$ and $B$ and $Y$ and apply it to the document visible to the user.
\item Apply $B$ to $A$.
\item Compute a new changeset by merging $B$ and $X$ and assign it to $X$
\item Compute a new changeset by merging $X$ and $B$ and $Y$ and assign it to $Y$
\end{enumerate}
