...
CodeMirror, ACE and Google's document editor each implement text selections by displaying \code{div} elements that mimick the look of a natural selection.

%To display a text selection while the input can be read from the input field, the selection must be mimicked too.
