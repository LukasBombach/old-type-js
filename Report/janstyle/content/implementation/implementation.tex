...
There are various input methods whith which users can interact with native inputs. This includes hardware devices as well as virtual (on screen) devices. This includes:
