...
The ''Type'' class is the starting point for developers to implement rich-text editors and to extend the library itself.
...
\begin{enumerate}
\item
\item Provide a constructor that will instantiate and set up all classes to provide a feature complete library instance to edit rich text.
\item Provid
\end{enumerate}
