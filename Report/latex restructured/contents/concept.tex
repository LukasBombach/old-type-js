...
The basic concept of creating DOM elements to imitate native components 

To imitate a native input the concepts of these editors can be used as a basis.
